...
const TeacherDashboard = () => {
  ...
  const [enrollmentRequests, setEnrollmentRequests] = useState([
    ...
    { 
      ...
      requestDate: '2025-03-21T14:15:00', 
      status: 'pending' 
    },
    { 
      id: 3, 
      ...
      requestDate: '2025-03-21T09:45:00', 
      status: 'pending' 
    }
  ]);
      ...
      <div className="dashboard-section">
        ...
        <div className="requests-container">
          {enrollmentRequests.map(request => (
            <div 
              key={request.id} 
              className={`request-card ${request.status !== 'pending' ? `request-${request.status}` : ''}`}
            >
